        ...
        constructor: i, _init: function () {
            ...
            if (this.$element.parent().hasClass("bootstrap-timepicker")) {
                if (this.$element.parent(".bootstrap-timepicker").find(".picker").length) {
                    this.$element.parent(".bootstrap-timepicker").find(".picker").on({"click.timepicker": e.proxy(this.showWidget, this)})
                } else {
                    this.$element.closest(this.containerClass).find(".input-group-addon").on({"click.timepicker": e.proxy(this.showWidget, this)})
                }
                this.$element.on({

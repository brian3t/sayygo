        ...
        constructor: c, _parseAttr: function (t, i) {
            ...
            e.initTouch(), e.$rating.on("click", function (t) {
                ...
                if (e.hoverEnabled && !e.inactive) {
                    e.starClicked = !1;
                    var a = t.pageX - e.$rating.offset().left, n = e.calculate(a);
                ...
                if (e.hoverEnabled && !e.inactive && e.hoverOnClear) {
                    e.clearClicked = !1;
                    var t, a = '<span class="' + e.clearCaptionClass + '">' + e.clearCaption + "</span>", n = e.clearValue, r = e.getWidthFromValue(n);
                    t = {
                        caption: a,
                        width: r,
                        val: n
            ...
            var a = this, n = "ontouchstart"in window || window.DocumentTouch && document instanceof window.DocumentTouch;
            if (n && !a.inactive) {
                var r = t.originalEvent, i = r.touches.length > 0 ? r.touches : r.changedTouches, l = i[0].pageX - a.$rating.offset().left;
                if (e)a.setStars(l), a.$element.trigger("change"), a.$element.trigger("rating.change", [a.$element.val(), a.$caption.html()]), a.starClicked = !0; else {
                    var o = a.calculate(l), s = o.val <= a.clearValue ? a.fetchCaption(a.clearValue) : o.caption, c = a.getWidthFromValue(a.clearValue), u = o.val <= a.clearValue ? a.rtl ? 100 - c + "%" : c + "%" : o.width;
            ...
            return e.showCaption ? (t = e.fetchCaption(a), r(e.$captionElement) ? '<div class="caption">' + t + "</div>" : (i(e.$captionElement, "caption"), e.$captionElement.attr({title: e.clearCaption}).html(t), "")) : ""
            ...
            var e = this, a = r(e.$element.val()) ? 0 : e.$element.val(), n = arguments.length ? e.getValueFromPosition(t) : a, i = e.fetchCaption(n), l = e.getWidthFromValue(n);

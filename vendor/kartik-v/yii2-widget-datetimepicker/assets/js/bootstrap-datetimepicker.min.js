!function (e) {
    ...
    i.prototype = {
        constructor: i, _events: [], _attachEvents: function () {
            ...
            if (null != this.date && null != this.viewDate) {
                var i = new Date(this.viewDate), n = i.getUTCFullYear(), h = i.getUTCMonth(), o = i.getUTCDate(), r = i.getUTCHours(), d = i.getUTCMinutes(), l = this.startDate !== -1 / 0 ? this.startDate.getUTCFullYear() : -1 / 0, c = this.startDate !== -1 / 0 ? this.startDate.getUTCMonth() : -1 / 0, u = 1 / 0 !== this.endDate ? this.endDate.getUTCFullYear() : 1 / 0, m = 1 / 0 !== this.endDate ? this.endDate.getUTCMonth() : 1 / 0, p = new t(this.date.getUTCFullYear(), this.date.getUTCMonth(), this.date.getUTCDate()).valueOf(), v = new Date;
                if (this.picker.find(".datetimepicker-days thead th:eq(1)").text(s[this.language].months[h] + " " + n), "time" == this.formatViewType) {
                    var g = r % 12 ? r % 12 : 12, f = (10 > g ? "0" : "") + g, w = (10 > d ? "0" : "") + d, D = s[this.language].meridiem[12 > r ? 0 : 1];
                    this.picker.find(".datetimepicker-hours thead th:eq(1)").text(f + ":" + w + " " + (D ? D.toUpperCase() : "")), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(f + ":" + w + " " + (D ? D.toUpperCase() : ""))
                } else this.picker.find(".datetimepicker-hours thead th:eq(1)").text(o + " " + s[this.language].months[h] + " " + n), this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(o + " " + s[this.language].months[h] + " " + n);
                this.picker.find("tfoot th.today").text(s[this.language].today).toggle(this.todayBtn !== !1), this.updateNavArrows(), this.fillMonths();
                var y = t(n, h - 1, 28, 0, 0, 0, 0), T = a.getDaysInMonth(y.getUTCFullYear(), y.getUTCMonth());
                y.setUTCDate(T), y.setUTCDate(T - (y.getUTCDay() - this.weekStart + 7) % 7);
                var M = new Date(y);
                M.setUTCDate(M.getUTCDate() + 42), M = M.valueOf();
                for (var C, k = []; y.valueOf() < M;)y.getUTCDay() == this.weekStart && k.push("<tr>"), C = "", y.getUTCFullYear() < n || y.getUTCFullYear() == n && y.getUTCMonth() < h ? C += " old" : (y.getUTCFullYear() > n || y.getUTCFullYear() == n && y.getUTCMonth() > h) && (C += " new"), this.todayHighlight && y.getUTCFullYear() == v.getFullYear() && y.getUTCMonth() == v.getMonth() && y.getUTCDate() == v.getDate() && (C += " today"), y.valueOf() == p && (C += " active"), (y.valueOf() + 864e5 <= this.startDate || y.valueOf() > this.endDate || -1 !== e.inArray(y.getUTCDay(), this.daysOfWeekDisabled)) && (C += " disabled"), k.push('<td class="day' + C + '">' + y.getUTCDate() + "</td>"), y.getUTCDay() == this.weekEnd && k.push("</tr>"), y.setUTCDate(y.getUTCDate() + 1);
                this.picker.find(".datetimepicker-days tbody").empty().append(k.join("")), k = [];
                for (var U = "", b = "", V = "", F = 0; 24 > F; F++) {
                    var S = t(n, h, o, F);
                    C = "", S.valueOf() + 36e5 <= this.startDate || S.valueOf() > this.endDate ? C += " disabled" : r == F && (C += " active"), this.showMeridian && 2 == s[this.language].meridiem.length ? (b = 12 > F ? s[this.language].meridiem[0] : s[this.language].meridiem[1], b != V && ("" != V && k.push("</fieldset>"), k.push('<fieldset class="hour"><legend>' + b.toUpperCase() + "</legend>")), V = b, U = F % 12 ? F % 12 : 12, k.push('<span class="hour' + C + " hour_" + (12 > F ? "am" : "pm") + '">' + U + "</span>"), 23 == F && k.push("</fieldset>")) : (U = F + ":00", k.push('<span class="hour' + C + '">' + U + "</span>"))
                }
                this.picker.find(".datetimepicker-hours td").html(k.join("")), k = [], U = "", b = "", V = "";
                for (var F = 0; 60 > F; F += this.minuteStep) {
                    var S = t(n, h, o, r, F, 0);
                    C = "", S.valueOf() < this.startDate || S.valueOf() > this.endDate ? C += " disabled" : Math.floor(d / this.minuteStep) == Math.floor(F / this.minuteStep) && (C += " active"), this.showMeridian && 2 == s[this.language].meridiem.length ? (b = 12 > r ? s[this.language].meridiem[0] : s[this.language].meridiem[1], b != V && ("" != V && k.push("</fieldset>"), k.push('<fieldset class="minute"><legend>' + b.toUpperCase() + "</legend>")), V = b, U = r % 12 ? r % 12 : 12, k.push('<span class="minute' + C + '">' + U + ":" + (10 > F ? "0" + F : F) + "</span>"), 59 == F && k.push("</fieldset>")) : (U = F + ":00", k.push('<span class="minute' + C + '">' + r + ":" + (10 > F ? "0" + F : F) + "</span>"))
                }
                this.picker.find(".datetimepicker-minutes td").html(k.join(""));
                var x = this.date.getUTCFullYear(), H = this.picker.find(".datetimepicker-months").find("th:eq(1)").text(n).end().find("span").removeClass("active");
                x == n && H.eq(this.date.getUTCMonth()).addClass("active"), (l > n || n > u) && H.addClass("disabled"), n == l && H.slice(0, c).addClass("disabled"), n == u && H.slice(m + 1).addClass("disabled"), k = "", n = 10 * parseInt(n / 10, 10);
                var N = this.picker.find(".datetimepicker-years").find("th:eq(1)").text(n + "-" + (n + 9)).end().find("td");
                n -= 1;
                for (var F = -1; 11 > F; F++)k += '<span class="year' + (-1 == F || 10 == F ? " old" : "") + (x == n ? " active" : "") + (l > n || n > u ? " disabled" : "") + '">' + n + "</span>", n += 1;
                N.html(k), this.place()
            }
            ...
            if (s.is(".glyphicon") && (s = e(s).parent().closest("span, td, th, legend")), 1 == s.length) {
                    ...
                    case"span":
                        if (!s.is(".disabled")) {
                            ...
                            if (s.is(".month") ? (this.viewDate.setUTCDate(1), r = s.parent().find("span").index(s), d = this.viewDate.getUTCDate(), this.viewDate.setUTCMonth(r), this.element.trigger({
                                    type: "changeMonth",
                                    date: this.viewDate
                                }), this.viewSelect >= 3 && this._setDate(t(o, r, d, l, c, u, 0))) : s.is(".year") ? (this.viewDate.setUTCDate(1), o = parseInt(s.text(), 10) || 0, this.viewDate.setUTCFullYear(o), this.element.trigger({
                                    type: "changeYear",
                                    date: this.viewDate
                                }), this.viewSelect >= 4 && this._setDate(t(o, r, d, l, c, u, 0))) : s.is(".hour") ? (l = parseInt(s.text(), 10) || 0, (s.hasClass("hour_am") || s.hasClass("hour_pm")) && (12 == l && s.hasClass("hour_am") ? l = 0 : 12 != l && s.hasClass("hour_pm") && (l += 12)), this.viewDate.setUTCHours(l), this.element.trigger({
                                    type: "changeHour",
                                    date: this.viewDate
                                }), this.viewSelect >= 1 && this._setDate(t(o, r, d, l, c, u, 0))) : s.is(".minute") && (c = parseInt(s.text().substr(s.text().indexOf(":") + 1), 10) || 0, this.viewDate.setUTCMinutes(c), this.element.trigger({
                                    type: "changeMinute",
                                    date: this.viewDate
                                }), this.viewSelect >= 0 && this._setDate(t(o, r, d, l, c, u, 0))), 0 != this.viewMode) {
                                var m = this.viewMode;
                    ...
                    case"td":
                        if (s.is(".day") && !s.is(".disabled")) {
                            ...
                            s.is(".old") ? 0 === r ? (r = 11, o -= 1) : r -= 1 : s.is(".new") && (11 == r ? (r = 0, o += 1) : r += 1), this.viewDate.setUTCFullYear(o), this.viewDate.setUTCMonth(r, d), this.element.trigger({
                                type: "changeDay",
                                date: this.viewDate
                            }), this.viewSelect >= 2 && this._setDate(t(o, r, d, l, c, u, 0))
                        }
                        var m = this.viewMode;
                        this.showMode(-1), this.fill(), m == this.viewMode && this.autoclose && this.hide()
                }
            ...
            }, i = h + t, a.setUTCMonth(i), (0 > i || i > 11) && (i = (i + 12) % 12); else {
    ...
    var s = e.fn.datetimepicker.dates = {
        ...
        parseDate: function (a, n, h, o) {
            ...
            var p, v, d, u = a && a.match(this.nonpunctuation) || [], a = new Date(0, 0, 0, 0, 0, 0, 0), g = {}, f = ["hh", "h", "ii", "i", "ss", "s", "yyyy", "yy", "M", "MM", "m", "mm", "D", "DD", "d", "dd", "H", "HH", "p", "P"], w = {
                hh: function (e, t) {
            ...
            if (w.M = w.MM = w.mm = w.m, w.dd = w.d, w.P = w.p, a = t(a.getFullYear(), a.getMonth(), a.getDate(), a.getHours(), a.getMinutes(), a.getSeconds()), u.length == n.parts.length) {
                for (var m = 0, D = n.parts.length; D > m; m++) {
                    if (p = parseInt(u[m], 10), d = n.parts[m], isNaN(p))switch (d) {
                        ...
                        case"p":
                        case"P":
                            p = e.inArray(u[m].toLowerCase(), s[h].meridiem)
                    }
                    g[d] = p
                }
                for (var y, m = 0; m < f.length; m++)y = f[m], y in g && !isNaN(g[y]) && w[y](a, g[y])
            }
            return a
        },
        formatDate: function (t, i, n, h) {
            ...
            if ("standard" == h)o = {
                ...
                i: t.getUTCMinutes(),
                s: t.getUTCSeconds()
            }, o.H = 2 == s[n].meridiem.length ? o.h % 12 == 0 ? 12 : o.h % 12 : o.h, o.HH = (o.H < 10 ? "0" : "") + o.H, o.P = o.p.toUpperCase(), o.hh = (o.h < 10 ? "0" : "") + o.h, o.ii = (o.i < 10 ? "0" : "") + o.i, o.ss = (o.s < 10 ? "0" : "") + o.s, o.dd = (o.d < 10 ? "0" : "") + o.d, o.mm = (o.m < 10 ? "0" : "") + o.m; else {
            ...
            for (var t = [], r = e.extend([], i.separators), d = 0, l = i.parts.length; l > d; d++)r.length && t.push(r.shift()), t.push(o[i.parts[d]]);

...
(function (a) {
    ...
    a.fn.borderSize = function () {
        var c = a(this).leftBorderWidth() + a(this).rightBorderWidth(), b = a(this).topBorderWidth() + a(this).bottomBorderWidth(), d = {
            width: c,
            height: b
        };
        return d
    ...
    !a.wij && a.extend({
        wij: {
            charValidator: new c, encodeString: function (b) {
...
(function (a) {
    ...
    a.widget("wijmo.wijtooltip", {
        options: {
            ...
            mouseTrailing: false,
            triggers: "hover",
            position: {my: "left bottom", at: "right top", offset: null},
            showCallout: true,
            ...
            showDelay: 150,
            hideDelay: 150,
            calloutAnimation: {duration: 1e3, disabled: false, easing: null},
            calloutFilled: true,
            modal: false,
            group: null,
            ajaxCallback: null,
            ...
            b._showAnimataionTimer = setTimeout(function () {
                ...
                o = ({
                    rt: {left: a.x - j - c, top: a.y - l},
                    rc: {left: a.x - j - c, top: a.y - i / 2},
                    rb: {left: a.x - j - c, top: a.y - l - d},
                    lt: {left: a.x + c, top: a.y - l},
                    lc: {left: a.x + c, top: a.y - i / 2},
                    lb: {left: a.x + c, top: a.y - l - d},
                    tl: {left: a.x - k, top: a.y + d},
                    tc: {left: a.x - j / 2, top: a.y + d},
                    tr: {left: a.x - k - c, top: a.y + d},
                    bl: {left: a.x - k, top: a.y - i - d},
                    bc: {left: a.x - j / 2, top: a.y - i - d},
                    br: {left: a.x - k - c, top: a.y - i - d}
                })[g];
            ...
            d.mouseTrailing && c.bind("mousemove.tooltip", function (a) {
                ...
                if (c.length === 2)b.showAt({
                    x: a.pageX + parseInt(c[0]),
                    y: a.pageY + parseInt(c[1])
                }); else b.showAt({x: a.pageX, y: a.pageY})
            });
            switch (d.triggers) {
                case"hover":
            ...
            var h = this, c = h._tooltip, j = {
                width: c.width(),
                height: c.height()
            }, b = h._flipCallout(d, j, i), a = b && b.flip, g, f;
            ...
            var h = this, l = h.options, j = h._tooltip, c = {
                h: false,
                v: false
            }, f = a(i), d = (l.position.collision || "flip").split(" ");
            ...
            var e = this, m = e.options, d = m.position, a = e._tooltip, p = a.is(":hidden"), f = e._setCalloutCss(), n = f ? f.split("") : null, b = [0, 0], h = "", g = a._callout, i, l, r, q, j, s = {
                width: a.width(),
                height: a.height()
            }, o, k;
            p && a.show();
...
(function (a) {
    ...
    a.widget("wijmo.wijsplitter", {
        options: {
            ...
            fullSplit: false,
            resizeSettings: {animationOptions: {duration: 100, easing: "swing", disabled: false}, ghost: false},
            panel1: {minSize: 1, collapsed: false, scrollBars: "auto"},
            panel2: {minSize: 1, collapsed: false, scrollBars: "auto"}
            ...
            a(".ui-resizable-handle", c.element).live("mouseover." + d, function () {
                if (b.disabled)return;
                g.addClass(e)
...
(function (a) {
    ...
    a.ui.plugin.add("resizable", "wijanimate", {
        stop: function (l) {
            ...
            c.animate(a.extend(g, f && e ? {top: f, left: e} : {}), {
...
(function (a) {
    ...
    a.widget("wijmo.wijprogressbar", a.ui.progressbar, {
        options: {
            ...
            indicatorImage: "",
            animationDelay: 0,
            animationOptions: {disabled: false, easing: null, duration: 500},
            ...
            if (!f.disabled && f.duration > 0)setTimeout(function () {
                a.wijmo.wijprogressbar.animations.progress({
                    content: b.valueDiv, complete: function () {
            ...
            if (c)if (b._isHorizontal())a.css("width", c + "%").css("height", ""); else a.css("height", c + "%").css("width", ""); else a.css({
                width: "",
                height: ""
            })
    ...
    a.widget("wijmo.wijdialog", a.ui.dialog, {
        options: {
            ...
            var c = [], b = this, h = b.options, d, g = {
                ...
                refresh: {visible: true, click: b.refresh, iconClassOn: "ui-icon-refresh"},
                toggle: {
                    visible: true,
                    click: b.toggle,
                ...
                minimize: {visible: true, click: b.minimize, iconClassOn: "ui-icon-minus"},
                maximize: {visible: true, click: b.maximize, iconClassOn: "ui-icon-extlink"},
                close: {visible: true, click: b.close, iconClassOn: "ui-icon-close"}
            }, e = h.captionButtons, f = b.uiDialogTitlebar;
            ...
            var a = this, d = {
                button: "restore",
                info: {visible: c, click: a.restore, iconClassOn: "ui-icon-newwin"}
...
(function (a) {
    ...
    a.widget("wijmo.wijaccordion", {
        options: {
            ...
            f.removeClass("ui-state-active").removeClass(this._headerCornerOpened).addClass("ui-state-default ui-corner-all").attr({
                "aria-expanded": "false",
                tabIndex: -1
            ...
            this.element.find(".ui-accordion-header").live(this.options.event + ".wijaccordion", jQuery.proxy(this._onHeaderClick, this)).live("keydown.wijaccordion", jQuery.proxy(this._onHeaderKeyDown, this)).live("mouseenter.wijaccordion", function () {
    ...
    a.extend(a.wijmo.wijaccordion, {
        animations: {
            slide: function (b, h) {
                ...
                b.toShow.css(b.horizontal ? {width: 0, overflow: "hidden"} : {
                    height: 0,
                    overflow: "hidden"
                }).stop(true, true).show();
        ...
        options: {
            ...
            if (a.browser.msie && a.browser.version < 7) {
                ...
                if (!b) {
                    ...
                    }).attr({src: "javascript:'<html></html>';", scrolling: "no", frameborder: "0", "tabIndex ": -1});
...
(function (a) {
    ...
    a.widget("wijmo.wijsuperpanel", {
        options: {
            allowResize: false,
            autoRefresh: false,
            animationOptions: {queue: false, disabled: false, duration: 250, easing: undefined},
            ...
            resizableOptions: {handles: "all", helper: "ui-widget-content wijmo-wijsuperpanel-helper"},
            resized: null,
            dragStop: null,
            painted: null,
            scrolling: null,
            ...
            e.draggable({
                axis: c === "h" ? "x" : "y", drag: function (c, a) {
                    b._dragging(c, a, b)
            ...
            if (r) {
                ...
                i = b ? "top" : "left";
                n = b ? {top: "0px", bottom: "auto", left: "auto", right: "auto"} : {
                    left: "0px",
                    right: "auto",
                    top: "auto",
                    bottom: "auto"
                ...
                o = b ? {top: "auto", right: "auto", left: "auto", bottom: "0px"} : {
                    left: "auto",
                    right: "0px",
                    top: "auto",
                    bottom: "auto"
...
(function (a) {
    ...
    a.widget("wijmo.wijtextbox", {
        options: {}, _create: function () {
            ...
            a.element.bind("mouseover." + a.widgetName, function () {
                b.addClass("ui-state-hover")
            }).bind("mouseout." + a.widgetName, function () {
                b.removeClass("ui-state-hover")
            }).bind("mousedown." + a.widgetName, function () {
                b.addClass("ui-state-active")
            }).bind("mouseup." + a.widgetName, function () {
                b.removeClass("ui-state-active")
            }).bind("focus." + a.widgetName, function () {
...
(function (a) {
    ...
    a.widget("wijmo.wijcheckbox", {
        _csspre: "wijmo-checkbox", _init: function () {
            ...
            if (c.is(":checkbox")) {
                ...
                c.data("boxElement", e);
                e.removeClass(d._csspre + "-relative").attr("role", "checkbox").bind("mouseover", function () {
                    c.mouseover()
                }).bind("mouseout", function () {
                    c.mouseout()
                });
                (h.length === 0 || h.html() === "") && e.addClass(d._csspre + "-relative");
                c.bind("click.checkbox", function () {
                    d.refresh()
...
(function (a) {
    ...
    a.widget("wijmo.wijradio", {
        _radiobuttonPre: "wijmo-wijradio", _create: function () {
            ...
            if (d.is(":radio")) {
                ...
                e.removeClass(c._radiobuttonPre + "-relative").attr("role", "radio").bind("mouseover", function () {
                    d.mouseover()
                }).bind("mouseout", function () {
                    d.mouseout()
                });
                ...
                c._setDefaul();
                d.bind("click.checkbox", function () {
                    d.focus();
                    c._refresh()
                }).bind("focus.checkbox", function () {
                    if (c.options.disabled)return;
    ...
    a.widget("wijmo.wijlist", {
        options: {
            ...
            c.addClass(g).attr({
                ...
                "aria-multiselectable": d.selectionMode === "multiple"
            ...
            if (d.superPanel === undefined) {
                i = {
                    ...
                    vScroller: {scrollSmallChange: k, scrollLargeChange: e}
                };
...
(function (a) {
    ...
    a.widget("wijmo.wijcalendar", {
        options: {
            ...
            c.wijpopup({
                showEffect: "slide",
                showOptions: {direction: d === "prevPreview" ? "right" : "left"},
                hideEffect: "slide",
                hideOptions: {direction: d === "prevPreview" ? "right" : "left"}
            });
            c.wijpopup("show", {
            ...
            d.effect("slide", {
                mode: "hide",
                direction: e === "horizontal" ? c ? "left" : "right" : c ? "up" : "down",
            ...
            a.effect("slide", {
                direction: e === "horizontal" ? c ? "right" : "left" : c ? "down" : "up",
                easing: this.options.easing || "easeOutBack",
                duration: this.options.duration
            }, function () {
            ...
            b.effect("slide", {
                mode: "hide",
                direction: i === "horizontal" ? g ? "left" : "right" : g ? "up" : "down",
                easing: this.options.easing || "easeOutBack",
                distance: (i === "horizontal" ? h : j) * d.length,
                duration: this.options.duration
            }, function () {
                c = b.children(":last");
            ...
            var d = a(this._myGrid.getHtml(true)).css({
                position: "absolute",
                top: 0,
                left: 0,
                opacity: 0
            }).appendTo(e).height(f), i = this._myGrid.getSelectedIndex(), l = Math.floor(i / 4), o = i - l * 4, k = m / 4, j = f / 3, n = {
                left: k * o,
                top: j * l,
                width: k,
                height: j
            ...
            j = a.effects.createWrapper(d).css({overflow: "hidden"}).removeClass("ui-effects-wrapper").addClass("wijmo-wijcalendar-aniwrapper").css(a.extend(l, {
            ...
            if (!this.element.data("preview.wijcalendar") && !this.options.disabled) {
                ...
                this.element.find(".wijmo-wijcalendar-prevpreview-button, .wijmo-wijcalendar-nextpreview-button").unbind("mouseenter.wijcalendar").unbind("mouseleave.wijcalendar").bind({
                    "mouseenter.wijcalendar": a.proxy(this.onPreviewMouseEnter, this),
                    "mouseleave.wijcalendar": a.proxy(this.onPreviewMouseLeave, this)
                });
                if (this._myGrid === undefined) {
                    this.element.find(".wijmo-wijcalendar-day-selectable").unbind().bind({
                        "click.wijcalendar": a.proxy(this.onDayClicked, this),
                        "mouseenter.wijcalendar": a.proxy(this.onDayMouseEnter, this),
                        "mouseleave.wijcalendar": a.proxy(this.onDayMouseLeave, this),
                        "mousedown.wijcalendar": a.proxy(this.onDayMouseDown, this),
                        "dragstart.wijcalendar": a.proxy(this.onDayDragStart, this)
                    });
                    !!this.options.selectionMode.month && this.element.find(".wijmo-wijcalendar-monthselector").unbind().bind({
                        "click.wijcalendar": a.proxy(this.onMonthSelectorClicked, this),
                        "mouseenter.wijcalendar": a.proxy(this.onMonthSelectorMouseEnter, this),
                        "mouseleave.wijcalendar": a.proxy(this.onMonthSelectorMouseLeave, this)
                    });
                    !!this.options.selectionMode.weekDay && this.element.find(".ui-datepicker-week-day").unbind().bind({
                        "click.wijcalendar": a.proxy(this.onWeekDayClicked, this),
                        "mouseenter.wijcalendar": a.proxy(this.onWeekDayMouseEnter, this),
                        "mouseleave.wijcalendar": a.proxy(this.onWeekDayMouseLeave, this)
                    });
                    !!this.options.selectionMode.weekNumber && this.element.find(".wijmo-wijcalendar-week-num").unbind().bind({
                        "click.wijcalendar": a.proxy(this.onWeekNumberClicked, this),
                        "mouseenter.wijcalendar": a.proxy(this.onWeekNumberMouseEnter, this),
                        "mouseleave.wijcalendar": a.proxy(this.onWeekNumberMouseLeave, this)
                    })
                } else this.element.find(".wijmo-wijcalendar-day-selectable").unbind().bind({
                    "click.wijcalendar": a.proxy(this.onMyGridClicked, this),
                    "mouseenter.wijcalendar": a.proxy(this.onMyGridMouseEnter, this),
                    "mouseleave.wijcalendar": a.proxy(this.onMyGridMouseLeave, this)
                })
            }
    ...
    d.prototype = {
        _html: null, writeTagLeftChar: function () {
    ...
    f.prototype = {
        _calendar: null, _optionName: "selectedDates", getDates: function () {
    ...
    g.prototype = {
        gridType: "month", selectedIndex: 0, calendar: null, culture: undefined, select: function (c) {
        ...
        animations: {
            slide: function (b, c) {
                ...
                if (b.expand)b.content.stop(true, true).animate(b.horizontal ? {
                    ...
                    height: "show",
                    opacity: "show"
                }, b); else b.content.stop(true, true).animate(b.horizontal ? {
                    width: "hide",
                    opacity: "hide"
                } : {height: "hide", opacity: "hide"}, b)
            }
        }
    })
})(jQuery);
        ...
        options: {
            ...
            a("li", c.rootMenu).each(function (m, l) {
                ...
                if (c.length === 0)f.addClass(n); else {
                    ...
                    if (c.is("a")) {
                        c.bind("mouseenter.wijmenuitem", function () {
            ...
            g.find("li:has(ul)").each(function () {
                ...
                if (l !== "default" && c.triggerEvent !== "mouseenter") {
                    ...
                    g.removeClass(e).addClass(e);
                    f = a(this).find("." + d + ":eq(0)");
                    f.bind("mouseenter.wijmenu", function (f) {
                        if (c.disabled || a(this).hasClass("ui-state-disabled"))return;
                        clearTimeout(j);
            ...
            g.find("." + d).bind("click.wijmenu", function (h) {
            ...
            c.find("li").each(function () {
                ...
                c.children("ul").removeClass("wijmo-wijmenu-list ui-widget-content ui-corner-all ui-helper-clearfix wijmo-wijmenu-child ui-helper-reset").attr("role", "").attr("aria-activedescendant", "").show().css({
                    left: "",
                    top: "",
                    position: ""
                }).attr("hidden", "")
            ...
            d.addClass("wijmo-wijmenu-content wijmo-wijmenu-current ui-widget-content ui-helper-clearfix").css({width: e.width()}).find("ul").css({
                width: e.width(),
                left: e.width()
            ...
            if (d.orientation === "horizontal")if (c.closest("ul").get(0) === this.rootMenu.get(0))b = {
                my: "left top",
                at: "left bottom"
            };
...
(function (a) {
    ...
    a.widget("wijmo.wijtabs", {
        ...
        _blindPanel: function (b, c) {
            ...
            f.animate(k, {
                duration: e.duration, step: function () {
        ...
        destroy: function () {
            ...
            this.lis.unbind(".tabs").add(this.panels).each(function () {
                if (a.data(this, "destroy.tabs"))a(this).remove(); else a(this).removeClass(["ui-state-default", "ui-corner-top", "ui-corner-bottom", "ui-corner-left", "ui-corner-right", "ui-tabs-selected", "ui-state-active", "ui-state-hover", "ui-state-focus", "ui-state-disabled", "ui-tabs-panel", "ui-widget-content", "ui-tabs-hide"].join(" ")).css({
                    position: "",
                    left: "",
                    top: ""

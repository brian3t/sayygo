(function (a) {
    a.fn.daterangepicker = function (s) {
        ...
        var u = (function () {
            ...
            a.each(e.presetRanges, function () {
                a('<li class="ui-daterangepicker-' + this.text.replace(/ /g, "") + ' ui-corner-all"><a href="#">' + this.text + "</a></li>").data("dateStart", this.dateStart).data("dateEnd", this.dateEnd).appendTo(y)
            });
            var w = 0;

!function (e) {
    ...
    e.extend(e.fn.modal.Constructor.prototype, {
        initLinks: function () {
            ...
            l.css({
                width: t.width,
                height: t.height
            }), o.find(".modal-title").css({width: Math.max(t.width, 380)}), a && (i = o.clone().hide().appendTo(document.body)), e(window).width() > 767 ? s.call(o.stop(), {
                "margin-top": -((i || o).outerHeight() / 2),
                "margin-left": -((i || o).outerWidth() / 2)
            }) : o.css({top: (e(window).height() - (i || o).outerHeight()) / 2}), i && i.remove(), l.append(t), n = t.offsetWidth, o.trigger("display"), a ? o.is(":visible") ? e(t).on(e.support.transition.end, function (i) {
            ...
            if (!this.isShown && this.$element.hasClass("modal-gallery")) {
                ...
                t.hasClass("modal-fullscreen") ? (this._loadImageOptions = {
                    maxWidth: o,
                    maxHeight: a,
                    canvas: n.canvas
                }, t.hasClass("modal-fullscreen-stretch") && (this._loadImageOptions.minWidth = o, this._loadImageOptions.minHeight = a)) : this._loadImageOptions = {
                    maxWidth: o - n.offsetWidth,
                    maxHeight: a - n.offsetHeight,
                    canvas: n.canvas
                }, o > 767 ? t.css({
                    "margin-top": -(t.outerHeight() / 2),
                    "margin-left": -(t.outerWidth() / 2)
                }) : t.css({top: (e(window).height() - t.outerHeight()) / 2}), this.initGalleryEvents(), this.initLinks(), this.$links.length && (t.find(".modal-slideshow, .modal-prev, .modal-next").toggle(1 !== this.$links.length), t.toggleClass("modal-single", 1 === this.$links.length), this.loadImage())
            }

...
(function () {
    ...
    CKEDITOR.dtd = function () {
        var b = CKEDITOR.tools.extend, c = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, d = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, i = {}, l = {"#": 1}, j = {
            center: 1,
            dir: 1,
            noframes: 1
        };
    ...
    (function () {
        ...
        var e = function (a) {
            ...
            u: 1,
            "var": 1
        }, i = CKEDITOR.dom.walker.bogus(), l = new CKEDITOR.dom.walker.whitespaces, j = new CKEDITOR.dom.walker.bookmark, m = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
    ...
    (function () {
        ...
        var r = {styles: 1, attributes: 1, classes: 1}, A = {
            styles: "requiredStyles",
            attributes: "requiredAttributes",
            classes: "requiredClasses"
        }, v = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, o = {
            styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/,
            classes: /\(([^\)]+)\)/
    ...
    (function () {
        ...
        var c = CKEDITOR.tools.extend({
            ...
            ol: 1,
            ul: 1
        }, e = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {
            style: 1,
            script: 1
        });
    ...
    (function () {
        ...
        var B = /(?:&nbsp;|\xa0)$/, z = "{cke_protected}", F = CKEDITOR.dtd, s = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], C = CKEDITOR.tools.extend({}, F.$blockLimit, F.$block), r = {
            elements: {},
    ...
    (function () {
        ...
        function a(a) {
            var b = a.name, c = a.element, e = a.elementMode, m = a.fire("uiSpace", {
                space: "top",
                html: ""
            }).html, n = a.fire("uiSpace", {space: "bottom", html: ""}).html;
    ...
    (function () {
        ...
        var n = function () {
            ...
            var k = CKEDITOR.dtd, j = {
                ...
                dl: 1,
                blockquote: 1
            }, n = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, m = CKEDITOR.tools.extend({}, k.$inline);
            delete m.br;
            return function (j, l, t) {
                ...
                if (!A.checkReadOnly()) {
                    var o = (new CKEDITOR.dom.elementPath(A.startContainer,
                        ...
                        mergeCandidates: [],
                        zombies: []
                    }, r = l.range, v = l.mergeCandidates, x, I, G, D;
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    if (n) {
                        var c = CKEDITOR.dom.walker.whitespaces(true), f = /\ufeff|\u00a0/, i = {
                            table: 1,
                            tbody: 1,
                            tr: 1
                        };
    ...
    (function () {
        ...
        var F = {
            ...
            audio: 1,
            video: 1
        }, C = /\s*(?:;\s*|$)/, r = /#\((.+?)\)/g, A = CKEDITOR.dom.walker.bookmark(0, 1), v = CKEDITOR.dom.walker.whitespaces(1);

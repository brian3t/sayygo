...
(function () {
    function r(a) {
        ...
        return {
            getCurrentLangGroup: function (c) {
                a:{
                    for (var d in a)for (var g in a[d])if (g.toUpperCase() === c.toUpperCase()) {
                        c = d;
                        break a
                    }
                    c = ""
    ...
    a.framesetHtml = function (b) {
        return '<iframe src="' + a.templatePath + a.serverLocation + '" id=' + a.iframeNumber + "_" + b + ' frameborder="0" allowtransparency="1" style="width:100%;border: 1px solid #AEB3B9;overflow: auto;background:#fff; border-radius: 3px;"></iframe>'
    };
    ...
    a.sendData = function (b) {
        ...
        b.parts.tabs.on("click", function (h) {
            h = h || window.event;
            h.data.getTarget().is("a") && c != b._.currentTabId && (c = b._.currentTabId, d = b._.contents[c].Content, e = a.iframeNumber + "_" + c, a.div_overlay.setEnable(), d.getElement().getChildCount() ? o(a.targetFromFrame[e], a.cmd[c]) : (a.setIframe(d, c), g = document.getElementById(e), a.targetFromFrame[e] =
                g.contentWindow))
        })
    };
    ...
    a.buildOptionLang = function (b) {
        ...
        a.CKNumber), d = document.createDocumentFragment(), e, g = [];
        if (0 === c.options.length) {
            for (e in b)g.push([e, b[e]]);
            g.sort();
            for (var h = 0; h < g.length; h++)b = document.createElement("option"), b.setAttribute("value", g[h][1]), e = document.createTextNode(g[h][0]), b.appendChild(e), g[h][1] == a.selectingLang && b.setAttribute("selected", "selected"), d.appendChild(b);
            c.appendChild(d)
        }
    };
    a.buildOptionSynonyms = function (b) {
        ...
        for (var c = 0; c < b.length; c++)a.selectNode.synonyms.add(b[c],
            b[c]);
    ...
    var l = function (a) {
        var c = document, d = a.target || c.body, e = a.id || "overlayBlock", g = a.opacity || "0.9", a = a.background || "#f1f1f1", h = c.getElementById(e), f = h || c.createElement("div");
        f.style.cssText = "position: absolute;top:30px;bottom:40px;left:1px;right:1px;z-index: 10020;padding:0;margin:0;background:" + a + ";opacity: " + g + ";filter: alpha(opacity=" + 100 * g + ");display: none;";
        f.id = e;
        h || d.appendChild(f);
        return {
            setDisable: function () {
        ...
        var e = new CKEDITOR.dom.element("div"), g = new CKEDITOR.dom.element("input"), h = new CKEDITOR.dom.element("label"), f = "wscGrammerSuggest" + b + "_" + c;
        ...
        var c = new r(b), b = document.getElementById("wscLang" + a.CKNumber), d = a.iframeNumber + "_" + a.dialog._.currentTabId;
        ...
        if ("no_any_suggestions" == b) {
            ...
            var c = function (b) {
                ...
                b.getElement().hasClass("cke_disabled") ?
                    b.getElement().setStyle("color", "#a0a0a0") : b.disable()
            };
            c("ChangeTo");
            c("ChangeAll")
        ...
        iframeOnload: function () {
            ...
            for (var b = b.grammSuggest, c = b.length, d = !0, e = 0; e < c; e++)a.grammerSuggest.getElement().append(u(b[e], b[e], d)), d = !1;
            i();
            a.div_overlay.setDisable()
            ...
            f.postMessage.send({message: b, target: a.targetFromFrame[a.iframeNumber + "_" + a.dialog._.currentTabId]})
        }, data: function (a) {
            delete a.id
    ...
    CKEDITOR.dialog.add("checkspell", function (b) {
        ...
        }, d = "file:" == document.location.protocol ? "http:" : document.location.protocol, e = CKEDITOR.config.wsc_customLoaderScript || d + "//loader.webspellchecker.net/sproxy_fck/sproxy.php?plugin=fck2&customerid=" + CKEDITOR.config.wsc_customerId + "&cmd=script&doc=wsc&schema=22";
        return {
            ...
            onShow: function () {
                ...
                CKEDITOR.scriptLoader.load(e, function (c) {
                    ...
                    a.div_overlay_no_check = new l({
                        opacity: "1", id: "no_check_over", background: "#fff url(" +
                        a.loadIconEmptyEditor + ") no-repeat 50% 50%", target: a.OverlayPlace
                    });
            ...
            contents: [{
                ...
                elements: [{type: "html", id: "banner", label: "banner", style: "", html: "<div></div>"}, {
                    ...
                    type: "hbox", id: "bottomGroup",
                    style: "width:560px; margin: 0 auto;", widths: ["50%", "50%"], children: [{
                        ...
                        type: "hbox", id: "rightCol", align: "right", width: "50%", children: [{
                            type: "vbox", id: "rightCol_col__left", widths: ["50%", "50%", "50%", "50%"], children: [{
                                type: "button", id: "ChangeTo", label: a.LocalizationButton.ChangeTo.text,
                                title: "Change to", style: "width: 100%;", onLoad: function () {
                            ...
                            type: "vbox", id: "rightCol_col__right", widths: ["50%", "50%", "50%"], children: [{
                                ...
                                title: "Option", style: "width: 100%;", onLoad: function () {
                    ...
                    onHide: i,
                    children: [{
                        type: "hbox", id: "leftCol", align: "left",
                        width: "70%", children: [{
                            type: "vbox",
                            id: "rightCol1",
                            setup: function () {
                    ...
                    type: "vbox", id: "bottomGroup", style: "width:560px; margin: 0 auto;", children: [{
                        type: "hbox", id: "leftCol", widths: ["66%", "34%"], children: [{
                            ...
                            children: [{
                                ...
                                type: "button", id: "IgnoreAllWords", label: "Ignore Problem", title: "Ignore Problem",
                                style: "width: 133px; float: right;", onLoad: function () {
                                    this.getElement().setAttribute("title-cmd", this.id)
                                }, onClick: c
                            }, {
                                type: "button",
                ...
                elements: [{type: "html", id: "banner", label: "banner", style: "", html: "<div></div>"}, {
                    ...
                    style: "width:560px; margin: 0 auto;", children: [{
    ...
    CKEDITOR.dialog.add("options", function () {
        ...
        return {
                    ...
                    type: "vbox", id: "Options_content", children: [{
                        type: "hbox", id: "Options_manager", widths: ["52%", "48%"], children: [{
                            ...
                            type: "vbox", id: "Options_DictionaryName", children: [{
                                ...
                                onLoad: function () {
                                    j = this;
                                    this.setValue(a.userDictionaryName ? a.userDictionaryName : (f.cookie.get("udn"), this.getValue()))
                                },
                                onShow: function () {
                                    j = this;
                                    this.setValue(!f.cookie.get("udn") ? this.getValue() : f.cookie.get("udn"));
                                ...
                                type: "hbox", id: "Options_buttons", children: [{
                                    type: "vbox", id: "Options_leftCol_col", widths: ["50%", "50%"], children: [{
                                        ...
                                        label: "Create", title: "Create", style: "width: 100%;", onLoad: function () {
                                            this.getElement().setAttribute("title-cmd", this.id)
                                        }, onShow: function () {
                                    ...
                                    type: "vbox", id: "Options_rightCol_col", widths: ["50%", "50%"],
                                    children: [{
                                        type: "button",
                                        id: "rename",
                                        label: "Rename",
            ...
            onShow: function () {
                ...
                !parseInt(d.IgnoreMixedCaseWords, 10) ? c.IgnoreMixedCaseWords.setValue("", !1) : c.IgnoreMixedCaseWords.setValue("checked",
                    !1);

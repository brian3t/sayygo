...
(function (e) {
    ...
    e.timeliner = function (n) {
        ...
        e(document).ready(function () {
            function n(n, r) {
                e(n).removeClass("closed").addClass("open").animate({fontSize: t.fontOpen}, t.baseSpeed);
                e(r).show(t.speed * t.baseSpeed)
            }

            function r(n, r) {
                e(n).animate({fontSize: t.fontClosed}, 0).removeClass("open").addClass("closed");
            ...
            e(".timelineMinor dt").click(function () {
            ...
            e(".timelineMajorMarker").click(function () {

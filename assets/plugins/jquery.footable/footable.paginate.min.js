(function (e, t, undefined) {
    ...
    function i() {
        ...
        t.name = "Footable Paginate", t.init = function (i) {
            i.options.paginate === !0 && e(i.table).bind({
        ...
        }, t.createPages = function (e, t) {
            var a = 1, i = e.pageInfo, o = a * i.pageSize, n = [], r = [];
            i.pages = [];
            var l = t.find("> tr:not(.footable-filtered,.footable-row-detail)");
            l.each(function (e, t) {
                n.push(t), e === o - 1 ? (i.pages.push(n), a++, o = a * i.pageSize, n = []) : e >= l.length - l.length % i.pageSize && r.push(t)
            }), r.length > 0 && i.pages.push(r), i.currentPage >= i.pages.length && (i.currentPage = i.pages.length - 1), 0 > i.currentPage && (i.currentPage = 0)
        }, t.createNavigation = function (a) {
            var i = e(a.table).find(a.pageInfo.pageNavigation);
            if (0 === i.length) {
                if (i = e(a.pageInfo.pageNavigation), i.parents("table:first") !== e(a.table))return;
    ...
    t.footable.plugins.register(new i, o)
})(jQuery, window);
...
jQuery.migrateMute === void 0 && (jQuery.migrateMute = !0), function (e, t, n) {
    ...
    var i = {}, u = e.attr, s = e.attrHooks.value && e.attrHooks.value.get || function () {
            return null
    ...
    a(e, "attrFn", i, "jQuery.attrFn is deprecated"), e.attr = function (t, a, o, i) {
        var s = a.toLowerCase(), c = t && t.nodeType;
    ...
    e.fn.andSelf = function () {
        ...
        var u, s, c, d, l = [];
        if (e.merge(l, e.buildFragment(t, a).childNodes), o)for (c = function (e) {
    ...
    var Q = e.event.add, x = e.event.remove, k = e.event.trigger, C = e.fn.toggle, N = e.fn.live, T = e.fn.die, H = "ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess", M = RegExp("\\b(?:" + H + ")\\b"), F = /(?:^|\s)hover(\.\S+|)\b/, A = function (t) {
    ...
    e.event.props && "attrChange" !== e.event.props[0] && e.event.props.unshift("attrChange", "attrName", "relatedNode", "srcElement"), a(e.event, "handle", e.event.dispatch, "jQuery.event.handle is undocumented and deprecated"), e.event.add = function (e, t, n, a, o) {
        ...
        var a = arguments, o = t.guid || e.guid++, i = 0, u = function (n) {

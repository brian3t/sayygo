...
<div id="header" class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="container">
		<div class="container-fluid">
			<div class="navbar-header"><a class="navbar-brand" href="/backend/web">
					REALTEAM
				</a></div>
				...
				<ul class="nav pull-right top-menu navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu extended logout">
							...
							<li><a class="yii-controls" href="/backend/web/site/logout"><i class="icon-key"></i> Log Out</a>
							</li>
						</ul>
					</li>
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a href="/backend/web/&lt;?= \Yii::$app-&gt;controller-&gt;id ?&gt;/index">

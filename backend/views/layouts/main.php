...
<div id="header" class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="navbar-inner">
		<div class="container-fluid">
			...
			<!--END SIDEBAR TOGGLE-->
			<!-- BEGIN LOGO -->
			<a class="navbar-brand" id="brand" href="/backend/web">
				REALTEAM
			</a>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu extended logout">
								...
								<li><a class="yii-controls" type="button" data-method="post"
								       href="/backend/web/site/logout"><i class="icon-key"></i> Log
										Out</a></li>
							</ul>
						</li>
					<?php else: ?>
						<li class="dropdown mtop5">
							<a class="element" data-placement="bottom" data-toggle="tooltip"
							   href="/backend/web/site/login" data-original-title="Help">
								Log In
							</a>
						</li>
					<?php endif; ?>
		...
		<div id="sidebar" class="row-no-padding collapse">
			...
			<ul class="sidebar-menu">
				...
				<li class="sub-menu">
					...
					<ul class="sub">
						<li><a class="" href="/backend/web/cuser/index">View All</a></li>
						<li><a class="" href="/backend/web/cuser/create">Create New</a></li>
					</ul>
				</li>
				<li class="sub-menu">
					<a href="javascript:;" class="">
					...
					<ul class="sub">
						<li><a class="" href="/backend/web/project/index">View All</a></li>
						<li><a class="" href="/backend/web/project/create">Create New</a></li>
					</ul>
				</li>
				<li class="sub-menu">
					<a href="javascript:;" class="">
					...
					<ul class="sub">
						<li><a class="" href="/backend/web/action/index">View All</a></li>
						<li><a class="" href="/backend/web/action/create">Create New</a></li>
					</ul>
				</li>
				<li class="sub-menu">
					<a href="javascript:;" class="">
					...
					<ul class="sub">
						<li><a class="" href="/backend/web/team/index">View All</a></li>
						<li><a class="" href="/backend/web/team/create">Create New</a></li>
					</ul>
				</li>
				<li class="sub-menu">
					<a href="javascript:;" class="">
					...
					<ul class="sub">
						<li><a class="" href="/backend/web/conversation/index">View All</a></li>
						<li><a class="" href="/backend/web/conversation/create">Create New</a></li>
					</ul>
				</li>
				<!--				<li>-->
			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					<ul class="breadcrumb col-md-6">
						<li>
							<a href="/backend/web">Home</a>

						</li>
						<li>
							<a href="/backend/web/<?= \Yii::$app->controller->id ?>/index"><?= \Yii::$app->controller->id ?></a>
...
<!-- BEGIN FOOTER -->
<div id="footer">
	2015 &copy; Real Estate Team App.
</div>
<!-- END FOOTER -->
